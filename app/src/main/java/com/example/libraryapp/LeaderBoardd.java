...
public class LeaderBoardd extends LinearLayout {
    ...
    public LeaderBoardd(Context context) {
        super(context);
        init(context);
    }

    public LeaderBoardd(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);

    }

    public LeaderBoardd(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);

    }

    public LeaderBoardd(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
